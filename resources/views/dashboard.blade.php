        ...
        <div class="card-body">
          <div class="row align-items-center">
            <div class="col">
              ...
              <div class="h2 metric mb-0">{{ $data_account }}</div>
            </div>
            <div class="col-auto">
        ...
        <div class="card-body">
          <div class="row align-items-center">
            <div class="col">
              ...
              <div class="h2 metric mb-0">{{ $total_service }}</div>
            </div>
            <div class="col-auto">
        ...
        <div class="card-body">
          <div class="row align-items-center">
            <div class="col">
              ...
              <div class="h2 metric mb-0">{{ $service_selesai }}</div>
            </div>
            <div class="col-auto">
        ...
        <div class="card-body">
          <div class="row align-items-center">
            <div class="col">
              ...
              <div class="h2 metric mb-0">{{ $service_reject }}</div>
            </div>
            <div class="col-auto">
        ...
        <div class="card-body">
          <div class="row align-items-center">
            <div class="col">
              ...
              <div class="h2 metric mb-0">{{ $total_bap }}</div>
            </div>
            <div class="col-auto">
    ...
    <div class="col-xl-3 col-md-6 mb-4 reveal d2">
      <div class="card card-stats h-100 shadow-sm fresh">
        <div class="card-body">
          <div class="row align-items-center">
            <div class="col">
              <h5 class="card-title small-muted mb-2">BAP Ditolak</h5>
              <div class="h2 metric mb-0">{{ $bap_reject }}</div>
            </div>
            <div class="col-auto">
              <span class="icon-ring"><i class="ni ni-fat-remove"></i></span>
            </div>
