...
<div class="container mt-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="d-flex gap-2">
      {{-- Tombol Ajukan Cuti (sementara disabled biar nggak 404, nanti aktif setelah modul Time-Off ready) --}}
      @if($u && $u->hasPrivilege('access_leave'))
        <a href="#" class="btn btn-outline-primary btn-sm disabled" aria-disabled="true">
          <i class="fas fa-plane-departure me-1"></i> Ajukan Cuti
        </a>
      @endif

      {{-- Tombol Import Absensi (sementara disabled, aktif setelah modul Absensi ready) --}}
      @if($u && $u->hasPrivilege('access_attendance'))
        ...
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              ...
              <div class="fs-3 fw-bold">{{ number_format($totalKaryawan) }}</div>
            </div>
        ...
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              ...
              <div class="fs-3 fw-bold">{{ number_format($cutiPending) }}</div>
            </div>
        ...
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              ...
              <div class="fs-3 fw-bold">{{ number_format($hadirHariIni) }}</div>
            </div>
