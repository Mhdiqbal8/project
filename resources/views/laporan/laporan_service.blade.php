    ...
    <div class="col">
      <div class="card">
        ...
        <div class="card-header border-0 d-flex align-items-center justify-content-between">
          ...
          {{-- Tombol shortcut ke ringkasan bulanan --}}
        ...
        <div class="card-body">
          ...
          <div class="form-group row ml-1">
            ...
            <form action="{{ route('laporan.service.search_excel') }}" method="get" class="ml-1">
            ...
            <form action="{{ route('laporan.service.search_pdf') }}" method="get" target="_blank" class="ml-1">
...
<script>
  ...
  function gotoBulanan() {
    ...
    window.location.href = `{{ route('laporan.service.bulanan') }}?month=${month}&year=${year}`;
  }
  ...
  async function search_report() {
    ...
    setLoading(true);
    try {
      const resp = await fetch('{{ route('laporan.service.search') }}', {
        method: 'POST',
        headers: {
          ...
          html += `
            <tr>
              ...
              <td class="text-center">
                <a target="_blank" href="{{ url('laporan_service/search_pdf_single') }}/${encodeURIComponent(id)}" class="btn btn-sm btn-info" title="Cetak Form">
